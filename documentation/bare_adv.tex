...
\begin{abstract}
Ziel des Projektes SmartBierdeggl ist es einen Bierdeckel zu konstruieren, der mitzählt wie oft man sich ein neues Bier geholt hat.
...
\hfil
\lstinputlisting[language=C,float=htbp]{code/hx711_init.c}
\hfil
...
\hfil
\lstinputlisting[language=C,float=htbp]{code/hx711_getValue.c}
\hfil

Die Daten werden dann in mg umgerechnet, mit einem empirisch bestimmten Skalierungsfaktor.

\hfil
\lstinputlisting[language=C,float=htbp]{code/main.c}
\hfil
...
einen Rechner einbauen, der berechnet ob und wann man wieder fahrtauglich ist.
