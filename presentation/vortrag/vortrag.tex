...
\begin{frame}{Motivation}
        ...
        \begin{adjustbox}{max width=.8\textwidth, max height=.8\textheight}
			\includegraphics[]{images/motivation}
        \end{adjustbox}
		\end{center}
\end{frame}
...
\begin{frame}{Erweiterungen}
	\begin{figure}
			\begin{center}
        \begin{adjustbox}{max width=.8\textwidth, max height=.4\textheight}
%			\subfigure[Unterscheidung von Getraenken]
			\includegraphics[]{images/getraenke}
%			\subfigure[Anzeige ob man noch fahrtuechtig ist]
			\includegraphics[]{images/auto}
%			\subfigure[Kommunikation mit Bedienung]
        \end{adjustbox}
		\end{center}
	\end{figure}
...
%\begin{frame}{Motivation}
%\begin{itemize}
%	\item Wachsende Zahl mobiler Geräte mit Android \
%	\visible<2->{\item Auslagerung bestimmter Funktionen von Prozessor auf Hardware}
%	\visible<4->{\item Zusammenspiel zwischen Hardware und Software muss berücksichtigt werden}
...
%	\begin{itemize}
%	\item Lädt Linux Kernel
%	\item Lädt Root File System (Android)
%	\item \only<2>{\textcolor{red}}{Lädt Devicetree}
%	\item Bootet Android
%	\end{itemize}
%	\end{itemize}
%
...
%	\begin{itemize}
%	\item Früher: Hardware Details in Kernel codiert
%	\\ $\rightarrow$ Bei Hardwareänderung musste Kernel neu kompiliert werden \pause
%	\item Einführung des Devicetrees
%	\begin{itemize}
%	\item Datenstruktur zur Hardwarebeschreibung
%	\item Separate Boot Datei
%	\item Wird von Bootloader geladen und dem Kernel übergeben
%	\item $\rightarrow$ Kernel kennt nun die Hardware
%	\end{itemize}
%	\end{itemize}
%	\pause
%	\begin{itemize}
%	\item Device Tree Source (.dts): ASCII Repräsentation des Devicetrees
%	\item Device Tree Blob (.dtb): Binäre Form des Devicetrees, für Kernel
...
%			
%	
%	\only<6->{\item Entwicklung der DMA Hardware-Software-Schnittstelle durch Implementierung des FPGA-Teils und des Android-Gerätetreibers} 
%			\only<7-7>{%
%		\begin{itemize}%
...
%	
%	
%	\only<1->{\item Entwicklung der DMA Hardware-Software-Schnittstelle durch Implementierung des FPGA-Teils und des Android-Gerätetreibers} \only<2->{\cmark} 
%			\only<2>{%
%		\begin{itemize}%
...
%	\item Eigenen Treiber für Hardware Architektur implementiert
%		\end{itemize}}
...
%	\only<9->{\item Prüfungsarbeit }\only<10->{\xmark} 
%	\end{itemize}
%	\end{block}
%
%	\end{frame}	
