...
\begin{figure*}[!t]
\centering
\subfloat[Abbildung 2: Atmega328p Pin Belegung]{\includegraphics[width=4in]{images/atmega328p_pin_belegung.png}%
\label{fig_atmega328_pin}}
\hfil
\subfloat[Abbildung 3: Konnektoren]{\includegraphics[width=2.5in]{images/bierdeckel_board_connectors.png}%
